(function () {
    var h = {}, mt = {}, c = {
        id: "45b58bc09aa65cf26f04dde532c7185c",
        dm: ["voice.bungba.com"],
        ...
        return function (d) {
            switch (typeof d) {
                ...
                default:
                    ...
                    n = ["{"];
                    f = mt.j.stringify;
                    for (k in d)if (Object.prototype.hasOwnProperty.call(d, k))switch (l =
                        d[k], typeof l) {
                        case "undefined":
                        case "unknown":
                        case "function":
    ...
    (function () {
        var a = mt.lang, b = h.B, e = h.load, d = {
            ta: function (d) {
    ...
    (function () {
        ...
        var e = mt.lang, d = mt.j, g = h.B, k = h.D, n = h.aa, f = {
            p: [], z: 0, Q: w, init: function () {
                f.e = 0;
                k.c("pv-b", function () {
                    f.ba();
                    f.da()
                ...
                if (0 < f.p.length)for (var a = 0, b = f.p.length; a < b; a++)f.K(f.p[a]);
                f.p = t
            }, K: function (a) {
                var b = a[0];
    ...
    (function () {
        ...
        a.prototype = {
            I: function (a, b) {
                ...
                try {
                    k.set(a, b, {domain: this.G(), path: this.N(), F: d}), d ? f.set(a, b, d) : l.set(a, b)
                } catch (e) {
                }
            }, va: function (a) {
                try {
                    k.set(a, "", {domain: this.G(), path: this.N(), F: -1}), l.remove(a), f.remove(a)
                } catch (b) {
                }
            }, Aa: function () {
                var a, b, d, e, f;
                ...
                try {
                    this.Ba(), 0 === this.a.nv ?
                        this.ya() : this.L(".*"), h.b = this, this.$(), v.r("pv-b"), this.xa()
                } catch (a) {
                    var b = [];
                    b.push("si=" + c.id);
    ...
    (function () {
        var a = mt.h, b = mt.lang, e = mt.event, d = mt.j;
        if ("undefined" !== typeof h.b && (c.med || (!a.ua || 7 < a.sa) && c.cvcc)) {
            ...
            if ("undefined" !== typeof f && "undefined" !== typeof n) {
                ...
                var u = function (a, d) {
                    ...
                    if (b.d(d, "Array") || b.d(d, "NodeList"))for (var e = 0, f = d.length; e < f; e++)if (q === d[e])return v(k + a + "/" + (e + 1), d[e]), w
                };
    ...
    (function () {
        var a = mt.o, b = mt.lang, e = mt.event, d = mt.j;
